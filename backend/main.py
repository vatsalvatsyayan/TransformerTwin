...
from api import routes_operator, routes_prognostics, routes_scenario, routes_sensor, routes_simulation
...
app.include_router(routes_prognostics.router, prefix=API_PREFIX)
